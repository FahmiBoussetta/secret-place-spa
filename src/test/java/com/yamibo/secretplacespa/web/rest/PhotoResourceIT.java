...
import com.yamibo.secretplacespa.repository.PhotoRepository;
...
class PhotoResourceIT {
    ...
    public static Photo createEntity(EntityManager em) {
        Photo photo = new Photo().name(DEFAULT_NAME);
        return photo;
    }
    ...
    public static Photo createUpdatedEntity(EntityManager em) {
        Photo photo = new Photo().name(UPDATED_NAME);
        return photo;
    }
    ...
    void putNewPhoto() throws Exception {
        ...
        updatedPhoto.name(UPDATED_NAME);
    ...
    void partialUpdatePhotoWithPatch() throws Exception {
        ...
        partialUpdatedPhoto.name(UPDATED_NAME);
