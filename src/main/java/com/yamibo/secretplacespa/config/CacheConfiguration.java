package com.yamibo.secretplacespa.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.yamibo.secretplacespa.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.yamibo.secretplacespa.repository.UserRepository.USERS_BY_EMAIL_CACHE);
