...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_BOOKING: 'booking/PARTIAL_UPDATE_BOOKING',
...
export default (state: BookingState = initialState, action): BookingState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BOOKING):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_BOOKING):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_BOOKING):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IBooking> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_BOOKING,
