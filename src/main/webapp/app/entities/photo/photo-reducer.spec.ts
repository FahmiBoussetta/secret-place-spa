...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PHOTO),
          REQUEST(ACTION_TYPES.UPDATE_PHOTO),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PHOTO),
          REQUEST(ACTION_TYPES.DELETE_PHOTO),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PHOTO),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PHOTO actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PHOTO),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PHOTO),
          payload: resolvedObject,
        },
      ];
