...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_RATING),
          REQUEST(ACTION_TYPES.UPDATE_RATING),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RATING),
          REQUEST(ACTION_TYPES.DELETE_RATING),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_RATING),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_RATING actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RATING),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_RATING),
          payload: resolvedObject,
        },
      ];
