...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_RATING: 'rating/PARTIAL_UPDATE_RATING',
...
export default (state: RatingState = initialState, action): RatingState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_RATING):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_RATING):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_RATING):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IRating> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_RATING,
